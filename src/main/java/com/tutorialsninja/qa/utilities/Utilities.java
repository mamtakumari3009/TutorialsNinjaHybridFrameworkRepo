...
public class Utilities {
	...
	public static final int PAGELOAD_WAIT = 30;

	public static String generateEmailWithTimeStamp() {
		Date date = new Date();
		String timeStamp = date.toString().replace(" ", "_").replace(":", "_");
		return "smamta"+timeStamp+"@gmail.com";
	}

	public static String generatePasswordWithTimeStamp() {
		Date date = new Date();
		String timeStampPsw = date.toString().replace(" ", "_").replace(":", "_");
		return "Mamta"+timeStampPsw+"Love";
	}
